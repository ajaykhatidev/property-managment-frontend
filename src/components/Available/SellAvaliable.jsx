...
export const SellAvaliable = () => {
  console.log("🎯 SellAvailable Component Mounted/Re-rendered");
  ...
  const handleDelete = useCallback(async (propertyId) => {
    ...
    try {
      ...
      console.log("🗑️ Starting delete for property:", propertyId);
  ...
  const handleEdit = useCallback(async (property) => {
    ...
    try {
      ...
      console.log("✏️ Navigating to edit property:", property._id);
